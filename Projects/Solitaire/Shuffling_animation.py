# Card Shuffling by Anjan Momi

# I accidentally made a shuffling animation while trying to get the deck
# to show 3 images at a time. This is the code for that animation. Click the 
# deck to watch the animation. 
